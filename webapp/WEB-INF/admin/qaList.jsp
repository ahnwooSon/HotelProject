...
<body>
	...
	<!-- <div class="container-fluid"> -->
				...
				<table class="table table-hover table-condensed">
					...
					<c:forEach items="${qaList}" var="qa" varStatus="status">
						<tr>
							...
							<td>
								<button onclick="location.href='deleteQa.ad?q_num=${qa.q_num }&pageNumber=${pageInfo.pageNumber}&whatColumn=${whatColumn }&keyword=${keyword}'" type="button" class="close" aria-label="Close">
		...
		<div class="row">
			<div class="col">
			<nav><ul class="pagination pagination-sm">${pageInfo.pagingHtml}</ul></nav>
			</div>
		</div>
	</div>
