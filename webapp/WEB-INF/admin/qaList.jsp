	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<ul class="nav nav-tabs nav-justified">
					...
					<li role="presentation" class="active"><a href="#">QA</a></li>
		...
		<div class="row">
			<div class="col page-header">
				<h1>QA관리 페이지<small>QA manager</small></h1>
						...
						<table class="table table-hover table-condensed">
							...
							<c:forEach items="${qaList}" var="qa" varStatus="status">
								<tr>
									...
									<td>
										<%-- <button onclick="location.href='deleteQa.ad?q_num=${qa.q_num }&pageNumber=${pageInfo.pageNumber}&whatColumn=${whatColumn }&keyword=${keyword}'"
											type="button" class="close" aria-label="Close">
											<span aria-hidden="true">&times;</span> --%>
										<a href="deleteQa.ad?q_num=${qa.q_num }&pageNumber=${pageInfo.pageNumber }&whatColumn=${whatColumn }&keyword=${keyword}"><i class="material-icons">delete_forever</i></a>
										</button>
									</td>
